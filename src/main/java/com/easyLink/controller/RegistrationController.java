...
public class RegistrationController {
	...
	public boolean getCheckPassword(@RequestBody Login login, HttpServletResponse httpServletResponse,
			@PathVariable(value = "username") String username) throws ClassNotFoundException, SQLException {
	...
	public Set<URL> getRegistrationLinks(@PathVariable(value = "username") String username,
	...
	public String getRegistrationLink(@PathVariable(value = "username") String username, @PathVariable String id,
			HttpServletResponse httpServletResponse) throws ClassNotFoundException, SQLException {
	...
	public InsertCheck addLink(@RequestBody URL link, @PathVariable(value = "username") String username)
			throws ClassNotFoundException, SQLException {
	...
	public InsertCheck editLink(@RequestBody URL link, @PathVariable(value = "username") String username,
			@PathVariable(value = "id") String id) throws ClassNotFoundException, SQLException {
	...
	public InsertCheck addRegistration(@RequestBody Registration registration)
		...
		if (dbManager.insertRegistration(registration.getUsername(), registration.getPassword(),
